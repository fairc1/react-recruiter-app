        ...
        <div className="p-2">
            <div className="card" style={{'width': '18rem'}}>
                ...
                <div className="card-body">
                    ...
                    <p className="card-text"><strong>Position: </strong>{props.recruit.position}</p>
                    ...
                    <div>
                        ...
                        <div className='d-flex justify-content-between'>
                            ...
                            <Link className='btn btn-xs btn-warning' to={{ pathname: `/recruit/edit/${props.recruit.id}`, state: {selectedRecruit: props.recruit} }}><button>Edit</button></Link>
                            <button
