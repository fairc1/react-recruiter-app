        ...
        <div className="p-2">
            <div className="card" style={{'width': '18rem'}}>
                ...
                <div className="card-body">
                    ...
                    <p className="card-text"><strong>Image: </strong>{props.recruit.image}</p>
                    ...
                    <div>
                        ...
                        <div className='d-flex justify-content-between'>
                            <Link className='btn btn-xs btn-primary' to={{ pathname: `/recruit/details/${props.recruit.id}`, state: {selectedRecruit: props.recruit} }}>DETAILS</Link>
